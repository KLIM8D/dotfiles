...
"highlight LineNr guifg=#f5cd4c
"exe 'hi LineNr guifg=#f5cd4c'
...
" map F2 to open previous buffer
map <F2> :previous<CR>
...
" Escape insert mode
imap jj <ESC>
" map CTRL + z to undo changes
nmap <C-z> :u<CR>
" map CTRL + z to undo changes (INSERT MODE)
imap <C-z> <ESC><C-z>i
" map CTRL + y to redo changes
nmap <C-y> :redo<CR>
